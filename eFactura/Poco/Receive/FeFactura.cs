...
{
    /// <summary>
    /// POCO class para construir fe-fc-v3.json
    /// </summary>
    /// <remarks>
    /// Clase para construir el json que corresponde a una <b>factura de consumidor final electrónica que se recibe de un proveedor</b> y enviar 
