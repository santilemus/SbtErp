...
namespace SBT.Apps.Activo.Module.BusinessObjects
{
    ...
    [ModelDefault("Caption", "Revertir Depreciación")]
    //[ImageName("BO_Unknown")]
    //[DefaultProperty("SampleProperty")]
    //[DefaultListViewOptions(MasterDetailMode.ListViewOnly, false, NewItemRowPosition.None)]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class DepreciacionRevertirParams : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        ...
        public DepreciacionRevertirParams()
        {
            Oid = Guid.NewGuid();
        }
        ...
        [ToolTip("Mes al cual corresponde la depreciación a revertir, solo puede revertir la depreciación del último mes, mientras no haya sido contabilizada")]
        [RuleRequiredField("DepreciacionRevertirParams.MesDepreciacion", "Accept")]
