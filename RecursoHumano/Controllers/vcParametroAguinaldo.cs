...
namespace SBT.Apps.RecursoHumano.Module.Controllers
{
    /// <summary>
    /// Recurso Humano.
    /// View Controller para el BO ParametroAguinaldo
    /// </summary>
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppViewControllertopic.aspx.
    public class vcParametroAguinaldo : ViewController
    {
        /// <summary>
        ...
        {
            // 
            // vcParametroAguinaldo
            // 
            this.TargetObjectType = typeof(SBT.Apps.RecursoHumano.Module.BusinessObjects.ParametroAguinaldo);
