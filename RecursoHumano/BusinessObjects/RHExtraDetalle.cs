...
namespace SBT.Apps.RecursoHumano.Module.BusinessObjects
{
    ...
    /// </summary>
    [DefaultClassOptions, ModelDefault("Caption", "HExtra Detalle"), NavigationItem(false), DefaultProperty("FechaTrabajo")]
    [Persistent("PlaRHExtraDetalle")]
    //[ImageName("BO_Contact")]
    //[DefaultListViewOptions(MasterDetailMode.ListViewOnly, false, NewItemRowPosition.None)]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class RHExtraDetalle : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public RHExtraDetalle(Session session)
            : base(session)
        {
        }
        ...
        [Association("RHExtra-Detalles"), XafDisplayName("Reporte HExtra")]
        public RHExtra RHExtra
        {
            get => rHExtra;
            set => SetPropertyValue(nameof(RHExtra), ref rHExtra, value);
        }
        
        [Association("ParametroJornada-TipoJornadas"), XafDisplayName("Tipo Jornada")]
        [RuleRequiredField("RHExtraDetalle.Jornada_Requerido", "Save")]
        ...
        [RuleRequiredField("RHExtraDetalle.HoraDesde_Requerido", DefaultContexts.Save, SkipNullOrEmptyValues = false)]
        ...
        [RuleValueComparison("RHExtraDetalle.HoraHasta > HoraDesde", DefaultContexts.Save, ValueComparisonType.GreaterThan, 
