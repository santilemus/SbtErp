...
-- grant permisos al role admins
grant select, references on ModelDifferenceAspect to admins 
grant select, references, insert, update, delete on UltrasonografiaObstetricaDetalle to admins 
grant select, references, insert, update, delete on ModuleInfo to admins 
grant select, references, insert, update, delete on UltrasonografiaPelvica to admins 
grant select, references, insert, update, delete on Moneda to admins 
grant select, references, insert, update, delete on UnidadMedida to admins 
grant select, references, insert, update, delete on Paciente to admins 
grant select, references, insert, update, delete on Usuario to admins 
grant select, references, insert, update, delete on PacienteFileData to admins 
grant select, references, insert, update, delete on Vacuna to admins 
grant select, references, insert, update, delete on PacienteMedico to admins 
grant select, references, insert, update, delete on XPObjectType to admins 
grant select, references, insert, update, delete on PacienteVacuna to admins 
grant select, references, insert, update, delete on XPWeakReference to admins 
grant select, references, insert, update, delete on Pariente to admins 
grant select, references, insert, update, delete on ZonaGeografica to admins 
grant select, references, insert, update, delete on PercentilTabla to admins 
grant select, references, insert, update, delete on PercentilTablaDetalle to admins 
grant select, references, insert, update, delete on PermissionPolicyActionPermissionObject to admins 
grant select, references, insert, update, delete on PermissionPolicyMemberPermissionsObject to admins 
grant select, references, insert, update, delete on PermissionPolicyNavigationPermissionsObject to admins 
grant select, references, insert, update, delete on PermissionPolicyObjectPermissionsObject to admins 
grant select, references, insert, update, delete on PermissionPolicyRole to admins 
grant select, references, insert, update, delete on PermissionPolicyTypePermissionsObject to admins 
grant select, references, insert, update, delete on PermissionPolicyUser to admins 
grant select, references, insert, update, delete on PermissionPolicyUserUsers_PermissionPolicyRoleRoles to admins 
grant select, references, insert, update, delete on Persona to admins 
grant select, references, insert, update, delete on ActividadEconomica to admins 
grant select, references, insert, update, delete on PersonaContacto to admins 
grant select, references, insert, update, delete on Afp to admins 
grant select, references, insert, update, delete on PersonaDocumento to admins 
grant select, references on Analysis to admins 
grant select, references, insert, update, delete on PersonaTelefono to admins 
grant select, references, insert, update, delete on AsociacionProfesional to admins 
grant select, references, insert, update, delete on PlanMedico to admins 
grant select, references, insert, update, delete on AuditDataItemPersistent to admins 
grant select, references, insert, update, delete on PlanMedicoDetalle to admins 
grant select, references, insert, update, delete on AuditedObjectWeakReference to admins 
grant select, references, insert, update, delete on ProblemaMedico to admins 
grant select, references, insert, update, delete on BugReport to admins 
grant select, references, insert, update, delete on ProCategoria to admins 
grant select, references, insert, update, delete on Cargo to admins 
grant select, references, insert, update, delete on Producto to admins 
grant select, references, insert, update, delete on Cita to admins 
grant select, references, insert, update, delete on ProductoAtributo to admins 
grant select, references, insert, update, delete on ConCatalogo to admins 
grant select, references, insert, update, delete on ProductoCodigoBarra to admins 
grant select, references, insert, update, delete on ConPeriodo to admins 
grant select, references, insert, update, delete on ProductoEnsamble to admins 
grant select, references, insert, update, delete on Constante to admins 
grant select, references, insert, update, delete on ProductoEquivalente to admins 
grant select, references, insert, update, delete on Consulta to admins 
grant select, references, insert, update, delete on ProductoLote to admins 
grant select, references, insert, update, delete on ConsultaDiagnostico to admins 
grant select, references, insert, update, delete on ProductoPrecio to admins 
grant select, references, insert, update, delete on ConsultaExamen to admins 
grant select, references, insert, update, delete on ProductoProveedor to admins 
grant select, references, insert, update, delete on ConsultaExamenFisico to admins 
grant select, references, insert, update, delete on Profesion to admins 
grant select, references, insert, update, delete on ConsultaIncapacidad to admins 
grant select, references, insert, update, delete on ProPresentacion to admins 
grant select, references, insert, update, delete on ConsultaParametro to admins 
grant select, references, insert, update, delete on RecordatorioClinico to admins 
grant select, references, insert, update, delete on ConsultaReceta to admins 
grant select, references, insert, update, delete on Regla to admins 
grant select, references, insert, update, delete on ConsultaSigno to admins 
grant select, references on ReportDataV2 to admins 
grant select, references, insert, update, delete on ConsultaSintoma to admins 
grant select, references, insert, update, delete on Resource to admins 
grant select, references, insert, update, delete on Empleado to admins 
grant select, references, insert, update, delete on ResourceResources_EventEvents to admins 
grant select, references, insert, update, delete on EmpleadoCapacitacion to admins 
grant select, references, insert, update, delete on SecuritySystemMemberPermissionsObject to admins 
grant select, references, insert, update, delete on EmpleadoMembresia to admins 
grant select, references, insert, update, delete on SecuritySystemObjectPermissionsObject to admins 
grant select, references, insert, update, delete on EmpleadoPariente to admins 
grant select, references, insert, update, delete on SecuritySystemRole to admins 
grant select, references, insert, update, delete on EmpleadoProfesion to admins 
grant select, references, insert, update, delete on SecuritySystemRoleParentRoles_SecuritySystemRoleChildRoles to admins 
grant select, references, insert, update, delete on Empresa to admins 
grant select, references, insert, update, delete on SecuritySystemTypePermissionsObject to admins 
grant select, references, insert, update, delete on EmpresaGiro to admins 
grant select, references, insert, update, delete on SecuritySystemUser to admins 
grant select, references, insert, update, delete on EmpresaTelefono to admins 
grant select, references, insert, update, delete on SecuritySystemUserUsers_SecuritySystemRoleRoles to admins 
grant select, references, insert, update, delete on EmpresaUnidad to admins 
grant select, references, insert, update, delete on Signo to admins 
grant select, references, insert, update, delete on Enfermedad to admins 
grant select, references, insert, update, delete on SysAuditoriaProceso to admins 
grant select, references, insert, update, delete on EstiloVida to admins 
grant select, references, insert, update, delete on SysConsulta to admins 
grant select, references, insert, update, delete on Event to admins 
grant select, references, insert, update, delete on TablaIMC to admins 
grant select, references, insert, update, delete on Examen to admins 
grant select, references, insert, update, delete on Telefono to admins 
grant select, references, insert, update, delete on FactorRiesgo to admins 
grant select, references, insert, update, delete on Tercero to admins 
grant select, references, insert, update, delete on FileData to admins 
grant select, references, insert, update, delete on TerceroContacto to admins 
grant select, references, insert, update, delete on HistoriaFamiliar to admins 
grant select, references, insert, update, delete on TerceroCredito to admins 
grant select, references, insert, update, delete on Inventario to admins 
grant select, references, insert, update, delete on TerceroDireccion to admins 
grant select, references, insert, update, delete on InventarioTipoMovimiento to admins 
grant select, references, insert, update, delete on TerceroDocumento to admins 
grant select, references, insert, update, delete on Kardex to admins 
grant select, references, insert, update, delete on TerceroGarantia to admins 
grant select, references, insert, update, delete on Listas to admins 
grant select, references, insert, update, delete on TerceroGiro to admins 
grant select, references, insert, update, delete on Medicamento to admins 
grant select, references, insert, update, delete on TerceroNota to admins 
grant select, references, insert, update, delete on MedicamentoDosis to admins 
grant select, references, insert, update, delete on TerceroRole to admins 
grant select, references, insert, update, delete on MedicamentoVia to admins 
grant select, references, insert, update, delete on TerceroSucursal to admins 
grant select, references, insert, update, delete on [Medico-Citas] to admins 
grant select, references, insert, update, delete on TerceroTelefono to admins 
grant select, references, insert, update, delete on MedicoConsultorio to admins 
grant select, references, insert, update, delete on TerminologiaAnatomica to admins 
grant select, references, insert, update, delete on MedicoEspecialidad to admins 
grant select, references, insert, update, delete on Tributo to admins 
grant select, references, insert, update, delete on MedLista to admins 
grant select, references, insert, update, delete on TributoCategoria to admins 
grant select, references, insert, update, delete on ModelDifference to admins 
grant select, references, insert, update, delete on UltraSonografiaObstetrica to admins 
