...
namespace SBT.Apps.Medico.Web {
    public class Global : System.Web.HttpApplication {
        ...
        private void Instance_LastLogonParametersWriting(object sender, LastLogonParametersWritingEventArgs e)
        {
            ...
            if (((CustomLogonParameters)e.LogonObject).Empresa != null)
            ...
            if (((CustomLogonParameters)e.LogonObject).Agencia != null)
        ...
        private void Instance_LoggedOn(object sender, LogonEventArgs e)
        {
            ...
            if (WebApplication.Instance.Model != null)
            {
                ...
                if (((CustomLogonParameters)e.LogonParameters).Empresa != null)
                {
        ...
        private static void application_CreateCustomLogonWindowObjectSpace(object sender, CreateCustomLogonWindowObjectSpaceEventArgs e)
        {
            ...
            {
                IObjectSpace objectSpaceEmpresa = ((XafApplication)sender).CreateObjectSpace(typeof(Empresa));
                ((NonPersistentObjectSpace)e.ObjectSpace).AdditionalObjectSpaces.Add(objectSpaceEmpresa);
            }
        }
